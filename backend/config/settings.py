"""
Django settings for GlamConnect project.
"""
...
INSTALLED_APPS = [
    ...
    'django.contrib.postgres',   # Required for ArrayField in profiles
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@glamconnect.com')
