...
AppSupportURL=http://127.0.0.1:8000
...
Filename: "netsh.exe"; Parameters: "advfirewall firewall add rule name=""GlamConnect Server"" dir=in action=allow protocol=TCP localport=8000 description=""Allows GlamConnect to be accessed from phones on your WiFi"""; Flags: runhidden; StatusMsg: "Configuring network..."
